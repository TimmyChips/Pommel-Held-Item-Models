package timmychips.relignitemodeldefinition.property.registry;

import net.minecraft.entity.LivingEntity;
import net.minecraft.item.ItemStack;
import net.minecraft.util.Identifier;
import timmychips.relignitemodeldefinition.property.handler.ConditionPropertyHandler;
import timmychips.relignitemodeldefinition.property.resolver.condition.*;
import timmychips.relignitemodeldefinition.property.resolver.condition.custom.HoveredItemBool;
import timmychips.relignitemodeldefinition.property.resolver.condition.custom.SubmergedBool;
